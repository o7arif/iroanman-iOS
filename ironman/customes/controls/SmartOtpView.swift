...
public enum SmartOtpViewAnimationType: Int {
    case none, dissolve, spring
}

public protocol SmartOtpViewDelegate: AnyObject {
    func digitsDidChange(smartOtpView: SmartOtpView)
    func digitsDidFinish(smartOtpView: SmartOtpView)
}

open class SmartOtpView: UIView {
    ...
    */
    ...
    open var animationType: SmartOtpViewAnimationType = .spring
    ...
    */
    ...
    open weak var delegate: SmartOtpViewDelegate?
    ...
    */
    fileprivate func didChange(_ backspaced: Bool = false) {
        ...
        if labels.count > 0, nextIndex < labels.count + 1 {
            ...
            delegate?.digitsDidFinish(smartOtpView: self)
        }
        delegate?.digitsDidChange(smartOtpView: self)
    }
...
extension SmartOtpView: UITextFieldDelegate {
